...
exports.validateOptions = exports.validateLength = void 0;
...
const validateCustomMemory = (length, options) => {
    ...
    if (options.customMemory < types_1.DEFAULT_BYTE_SIZE + length) {
        /* tslint:disable-next-line:no-console */
    ...
    if (options.customMemory > (types_1.DEFAULT_BYTE_SIZE + length) * 2) {
        /* tslint:disable-next-line:no-console */
